...
public class LabsModule extends PApplet {
    ...
    void mouseDragged() {
        if (curr_knob != null && mouseButton == LEFT) {
            ...
            curr_knob.value = constrain(map(this.mouseY, starting_knob_mouse_Ypos + knob_sensitivity, starting_knob_mouse_Ypos - knob_sensitivity, starting_knob_value - 1.0, starting_knob_value + 1.0), curr_knob.lower_bound, curr_knob.upper_bound);
        }
